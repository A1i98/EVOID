...
export const sidebar: SidebarEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Cluster', slug: 'learn/cluster' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Data Loss', slug: 'tutorial/data-loss' },
      { label: 'Who is Ordering?', slug: 'tutorial/who-is-ordering' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Cookie Parameters', slug: 'reference/cookie-params' },
      { label: 'Header Parameters', slug: 'reference/header-params' },
      { label: 'Form Data', slug: 'reference/form-data' },
      { label: 'File Upload', slug: 'reference/file-upload' },
      { label: 'CORS', slug: 'reference/cors' },
      { label: 'Static Files', slug: 'reference/static-files' },
      { label: 'Streaming', slug: 'reference/streaming' },
      { label: 'Custom Adapters', slug: 'reference/custom-adapters' },
    ],
  },
